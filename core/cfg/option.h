...
extern bool SkipAllFrame;      ///< 为true时，强制跳过所有帧
extern int SkipFrame;      ///< 为 0 时不跳帧，为其他时 每SkipFrame跳一帧
extern int AutoSkipFrame;
...
constexpr bool ThreadedRendering = true;
...
static constexpr bool GGPOEnable = false;
// extern Option<int> GGPODelay;
extern int GGPODelay;
