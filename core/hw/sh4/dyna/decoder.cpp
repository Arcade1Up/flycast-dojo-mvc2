...
_end:
	...
	{
		// mvsc2u kmWaitVBlank
		if ((rbi->addr >= 0x0c21865a && rbi->addr < 0x0c218676)
				// mvsc2u waitForEndOfRender
				|| (rbi->addr >= 0xc0273ca && rbi->addr < 0x0c0273e4)
				// mvsc2u nlaMapleCommand
				|| (rbi->addr >= 0xc1f603c && rbi->addr < 0xc1f6042)) {
